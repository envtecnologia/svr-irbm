...
@section('content')
    ...
    <form action="{{ route('tipo_atividades.index') }}" method="GET">
            ...
            <div class="col-8">
                ...
                <div class="row">
                    ...
                    <div class="col-6 mb-3">
                        <label for="descricao" class="form-label">Tipo de Atividades</label>
                ...
                <table class="table table-hover table-bordered table-custom">
                    ...
                    @forelse ($dados as $key => $dado)
                        <tr>
                            ...
                            <td>
                                <!-- Botão de editar -->
                                <a class="btn-action" href="{{ route('tipo_atividades.edit', ['id' => $dado->id]) }}"><i class="fa-solid fa-pen-to-square" data-bs-toggle="popover" data-bs-content="Editar"></i></a>

                                <!-- Botão de excluir (usando um formulário para segurança) -->
                                <form action="{{ route('tipo_atividades.delete', ['id' => $dado->id]) }}" method="POST" class="d-inline delete-form">
                                    @csrf
                                    @method('DELETE')
