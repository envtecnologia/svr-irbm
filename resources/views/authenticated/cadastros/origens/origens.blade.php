            ...
            <div class="col-8">
                ...
                <div class="row">
                    ...
                    <div class="col-6 mb-3">
                        <label for="descricao" class="form-label">Origem</label>
                    ...
                    <div class="col-6 mb-3 d-flex align-items-end justify-content-end">
                        <div>
                            ...
                            @if(request()->is('search/origens'))
                                <a class="btn btn-custom inter inter-title" href="/cadastros/origens">Limpar Pesquisa</a>
                            @endif
                        </div>
                    </div>
                ...
                <table class="table table-hover table-bordered table-custom">
                    ...
                    @forelse ($dados as $key => $dado)
                        <tr>
                            ...
                            <td>
                                <!-- Botão de editar -->
                                <a class="btn-action" href="{{ route('origens.edit', ['id' => $dado->id]) }}"><i class="fa-solid fa-pen-to-square"></i></a>
                    ...
                    <div class="mb-2">
                        <a class="btn btn-custom inter inter-title" href="{{ route('origens.new') }}">Novo +</a>
                    </div>
                </div>
