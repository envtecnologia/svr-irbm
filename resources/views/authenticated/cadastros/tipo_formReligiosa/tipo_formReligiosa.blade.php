                ...
                <div class="row">
                    ...
                    <div class="col-6 mb-3 d-flex align-items-end justify-content-end">
                        <div>
                            ...
                            @if(request()->is('search/tipo_formReligiosa'))
                                <a class="btn btn-custom inter inter-title" href="/cadastros/tipo_formReligiosa">Limpar Pesquisa</a>
                            @endif
                        </div>
                    </div>
                ...
                <table class="table table-hover table-bordered table-custom">
                    ...
                    @forelse ($dados as $key => $dado)
                        <tr>
                            ...
                            <td>
                                <!-- Botão de editar -->
                                <a class="btn-action" href="{{ route('tipo_formReligiosa.edit', ['id' => $dado->id]) }}"><i class="fa-solid fa-pen-to-square" data-bs-toggle="popover" data-bs-content="Editar"></i></a>

                                <!-- Botão de excluir (usando um formulário para segurança) -->
                                <form action="{{ route('tipo_formReligiosa.delete', ['id' => $dado->id]) }}" method="POST" class="d-inline delete-form">
                                    @csrf
                                    @method('DELETE')
                    ...
                    <div class="mb-2">
                        <a class="btn btn-custom inter inter-title" href="{{ route('tipo_formReligiosa.new') }}">Novo +</a>
                    </div>
                </div>
