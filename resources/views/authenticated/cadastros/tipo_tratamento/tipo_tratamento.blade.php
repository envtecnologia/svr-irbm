...
@section('content')
    ...
    <form action="{{ route('searchTipoTratamento') }}" method="POST">
        @csrf
            ...
            <div class="col-8">
                ...
                <div class="row">
                    ...
                    <div class="col-6 mb-3">
                        <label for="search" class="form-label">Tipo de Tratamento</label>
                ...
                <table class="table table-hover table-bordered table-custom">
                    ...
                    @forelse ($dados as $key => $dado)
                        <tr>
                            ...
                            <td>
                                <!-- Botão de editar -->
                                <a class="btn-action" href="{{ route('tipo_tratamento.edit', ['id' => $dado->id]) }}"><i class="fa-solid fa-pen-to-square"></i></a>
