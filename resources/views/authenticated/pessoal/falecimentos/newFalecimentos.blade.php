            ...
            <div class="col-6 mb-3">
                ...
                <div class="row mt-2">
                    <div class="col-8">
                        ...
                        <input type="text" class="form-control" id="translado" name="site" value="{{ request()->is('pessoal/falecimentos/new') ? '' : $dados->egresso }}" required>
                    </div>
                </div>
            ...
            <div class="col-6 mb-3">
                ...
                <div class="row mt-2">
                    <div class="col-8">
                        ...
                        <input type="text" class="form-control" id="detalhes" name="site" value="{{ request()->is('pessoal/falecimentos/new') ? '' : $dados->egresso }}" required>
                    </div>
                </div>
