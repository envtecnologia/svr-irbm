    ...
    <div class="row d-flex justify-content-center g-3 mt-4">
        <div class="col-10">
            <div class="table-container">
                ...
                <div class="mb-2">
                    <a class="btn btn-custom inter inter-title" target="{{ request()->is('relatorio/pessoal/egresso') ? '_blank' : '_self' }}" href="{{ request()->is('relatorio/pessoal/egresso') ? route('civil.pdf') : route('civil.new')  }}">{{ request()->is('relatorio/pessoal/egresso') ? 'Imprimir' : 'Novo +'  }}</a>
                </div>
            </div>
