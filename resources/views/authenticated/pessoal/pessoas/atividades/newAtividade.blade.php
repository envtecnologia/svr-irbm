...
@section('content')
    ...
    <form
        action="{{ Route::currentRouteName() === 'pessoas.atividades.edit' ? route('pessoas.atividades.update', ['pessoa_id' => $pessoa_id, 'atividade' => $dados->id]) : route('pessoas.atividades.store', ['pessoa_id' => $pessoa_id]) }}"
        method="POST">
        @csrf

        @if (Route::currentRouteName() === 'pessoas.atividades.edit')
            @method('PUT')
        @endif
                ...
                <div class="row d-flex justify-content-center g-3">
                    ...
                    <div class="col-6 mb-3">
                        ...
                        <div class="row rounded p-2 mb-3" style="background-color: #e0dac5">
                            ...
                            <select class="form-select" id="cod_comunidade_id" name="cod_comunidade_id" required>
                                ...
                                @forelse($comunidades as $r)
                                    <option value="{{ $r->id }}" @if (Route::currentRouteName() === 'pessoas.atividades.edit' && $r->id == $dados->cod_comunidade_id) selected @endif>
                                        {{ $r->descricao }}
                                    </option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="cod_obra_id" class="form-label">Obra<span class="required">*</span></label>
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-6">
                                <label for="datainicio" class="form-label">Chegada<span class="required">*</span></label>
                                <input type="date" id="datainicio" name="datainicio" class="form-control"
                                    value="{{ Route::currentRouteName() === 'pessoas.atividades.edit' ? $dados->datainicio : '' }}">
                            </div>

                            <div class="col-6">
                                <label for="datafinal" class="form-label">Saída</label>
                                <input type="date" id="datafinal" name="datafinal" class="form-control"
                                    value="{{ Route::currentRouteName() === 'pessoas.atividades.edit' ? $dados->datafinal : '' }}">
                            </div>
                        ...
                        <div class="row mt-2">
                            <div class="col-12">
                                ...
                                <input type="text" name="responsavel" class="form-control"
                                    value="{{ Route::currentRouteName() === 'pessoas.atividades.edit' ? $dados->responsavel : '' }}">
                            </div>
                        </div>
