...
@section('content')
    ...
    <form
        action="{{ Route::currentRouteName() === 'pessoas.formacoes.edit' ? route('pessoas.formacoes.update', ['pessoa_id' => $pessoa_id, 'formaco' => $formaco]) : route('pessoas.formacoes.store', ['pessoa_id' => $pessoa_id]) }}"
        method="POST">
        @csrf
