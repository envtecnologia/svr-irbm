                                    ...
                                    <div>
                                        <div class="mb-2">
                                            <form id="pdfForm" method="POST" action="{{ route('actionButton') }}">
                                                ...
                                                <button class="btn btn-custom inter inter-title" id="{{ request()->is('relatorios/pessoal/mediaIdade') ? 'action-button' : 'new-button' }}">{{ request()->is('relatorios/pessoal/mediaIdade') ? 'Imprimir' : 'Novo +'  }}</button>
                                            </form>
                                        </div>
                                        @if (request()->is('search/medIdade'))
                                            <a class="btn btn-custom inter inter-title" href="/controle/medIdade">Limpar Pesquisa</a>
