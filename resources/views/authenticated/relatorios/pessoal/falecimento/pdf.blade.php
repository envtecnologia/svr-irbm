...
<body>
    ...
    <main class="table-container">
        ...
        <div style="text-align: center;" class="highlight">Relatório de Falecimentos ({{ $records }} registros)</div>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th style="width: 140px;">Pessoa</th>
                    <th style="width: 120px;">Cemitério</th>
                    <th style="width: 80px;">Jazigo</th>
                    <th style="width: 100px;">Doença</th>
                </tr>
            </thead>
            <tbody>
