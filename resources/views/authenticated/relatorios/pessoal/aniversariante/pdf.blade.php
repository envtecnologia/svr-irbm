...
<body>
    ...
    <main class="table-container">
        <div style="text-align: center;" class="highlight">Relatório de Aniversariantes ({{ $records }} registros)</div>
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th style="width: 120px;">Comunidade</th>
                            <th style="width: 30px;">Aniversário</th>
                    ...
                    <tbody>
                        @foreach($dados as $index => $item)
                            <tr>
                                ...
                                <td style="text-align: center;">{{ $item['telefone1'] ?? 'N/A' }}</td>
