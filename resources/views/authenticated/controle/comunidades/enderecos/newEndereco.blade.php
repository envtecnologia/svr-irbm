...
@section('content')
    ...
    <form
        action="{{ request()->routeIs('enderecos.new') ? route('enderecos.create') : route('enderecos.update') }}"
        method="POST">
        @csrf
        <div class="row justify-content-center g-3 d-flex mt-5">
            ...
            <div class="col-12">
                ...
                <div class="row d-flex justify-content-center g-3">
                    <input value="{{ request()->routeIs('enderecos.new') ? '' : $dados->id }}" name="id" hidden>
                    <input value="{{ $id_comunidade }}" name="cod_comunidade_id" hidden>
                    {{-- PRIMEIRA COLUNA --}}
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col">
                                    ...
                                    <select class="form-select" id="cod_provincia_id" name="cod_provincia_id"
                                        value="{{ request()->routeIs('enderecos.new') ? '' : $dados->cod_provincia_id }}"
                                        required>
                            ...
                            <div class="row mt-2">
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" id="endereco" name="endereco"
                                        value="{{ request()->routeIs('enderecos.new') ? '' : $dados->endereco }}"
                                        required>
                                </div>
                                ...
                                <div class="col-4">
                                    ...
                                    <input type="cep" class="form-control" id="cep" name="cep"
                                        value="{{ request()->routeIs('enderecos.new') ? '' : $dados->cep }}">
                                </div>
                            </div>
                            ...
                            <div class="row mt-2">
                                <div class="col-6">
                                    ...
                                    <input type="date" class="form-control" id="datainicio" name="datainicio"
                                        value="{{ request()->routeIs('enderecos.new') ? '' : $dados->datainicio }}">
                                </div>
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="date" class="form-control" id="datafinal" name="datafinal"
                                        value="{{ request()->routeIs('enderecos.new') ? '' : $dados->datafinal }}">
                                </div>
                            </div>
