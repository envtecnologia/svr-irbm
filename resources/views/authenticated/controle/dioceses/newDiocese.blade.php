...
@section('title', 'Nova Diocese')

@section('content')

    <div class="row mt-5">
        <h2 class="text-center">Nova Diocese</h2>
    </div>

    <form action="{{ request()->is('controle/dioceses/new') ? route('dioceses.create') : route('dioceses.update') }}"
        method="POST">
        @csrf
        <div class="row justify-content-center g-3 d-flex mt-5">
            ...
            <div class="col-12">
                ...
                <div class="row d-flex justify-content-center g-3">
                    <input value="{{ request()->is('controle/dioceses/new') ? '' : $dados->id }}" name="id" hidden>
                    {{-- PRIMEIRA COLUNA --}}
                    <div class="col-8 mb-3">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="row mt-2">
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" id="descricao" name="descricao"
                                        value="{{ request()->is('controle/dioceses/new') ? '' : $dados->descricao }}"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="row mt-2">
                                <div class="col-8">
                                    ...
                                    <input type="text" class="form-control" id="endereco" name="endereco"
                                        value="{{ request()->is('controle/dioceses/new') ? '' : $dados->endereco }}"
                                        required>
                                </div>
                                ...
                                <div class="col-4">
                                    ...
                                    <input type="cep" class="form-control" id="cep" name="cep"
                                        value="{{ request()->is('controle/dioceses/new') ? '' : $dados->cep }}">
                                </div>
                            </div>
                            ...
                            <div class="row mt-2">
                                <div class="col-8">
                                    ...
                                    <input type="text" class="form-control" id="site" name="site"
                                        value="{{ request()->is('controle/dioceses/new') ? '' : $dados->site }}"
                                        required>
                                </div>
                                ...
                                <div class="col-4">
                                    ...
                                    <input type="caixapostal" class="form-control" id="caixapostal" name="caixapostal"
                                        value="{{ request()->is('controle/dioceses/new') ? '' : $dados->caixapostal }}">
                                </div>
                            </div>
                            ...
                            <div class="row mt-2">
                                <div class="col">
                                    ...
                                    <input type="email" class="form-control" id="email" name="email"
                                        value="{{ request()->is('controle/dioceses/new') ? '' : $dados->email }}"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="row mt-2">
                                <div class="col-4">
                                    ...
                                    <input type="text" class="form-control" id="telefone1" name="telefone1"
                                        value="{{ request()->is('controle/dioceses/new') ? '' : $dados->telefone1 }}"
                                        required>
                                </div>
                                ...
                                <div class="col-4">
                                    ...
                                    <input type="text" class="form-control" id="telefone2" name="telefone2"
                                        value="{{ request()->is('controle/dioceses/new') ? '' : $dados->telefone2 }}"
                                        required>
                                </div>
                                ...
                                <div class="col-4">
                                    ...
                                    <input type="text" class="form-control" id="telefone3" name="telefone3"
                                        value="{{ request()->is('controle/dioceses/new') ? '' : $dados->telefone3 }}"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="row mt-2">
                                <div class="col">
                                    <label for="bispo" class="form-label">Bispo<span class="required">*</span></label>
                                    <input type="text" class="form-control" id="bispo" name="bispo"
                                        value="{{ request()->is('controle/dioceses/new') ? '' : $dados->bispo }}"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="row mt-2">
                                <div class="col-6">
                                    ...
                                    <input type="date" class="form-control" id="fundacao" name="fundacao"
                                        value="{{ request()->is('controle/dioceses/new') ? '' : $dados->fundacao }}"
                                        required>
                                </div>
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="date" class="form-control" id="encerramento" name="encerramento"
                                        value="{{ request()->is('controle/dioceses/new') ? '' : $dados->encerramento }}"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="row mt-2">
                                <div class="col">
                                    ...
                                    <textarea class="form-control" id="detalhes" name="detalhes">{{ request()->is('controle/dioceses/new') ? '' : $dados->detalhes }}</textarea>
                                </div>
                            </div>
