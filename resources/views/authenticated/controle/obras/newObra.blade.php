...
@section('content')
    ...
    <div class="row mt-5">
        <h2 class="text-center">Nova Obra</h2>
    </div>

    <form
        action="{{ request()->is('controle/obras/new') ? route('obras.create') : route('obras.update') }}"
        method="POST">
        @csrf
        <div class="row justify-content-center g-3 d-flex mt-5">
            ...
            <div class="col-12">
                ...
                <div class="row d-flex justify-content-center g-3">
                    <input value="{{ request()->is('controle/obras/new') ? '' : $dados->id }}" name="id" hidden>
                    {{-- PRIMEIRA COLUNA --}}
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col">
                                    ...
                                    <select class="form-select" id="cod_provincia_id" name="cod_provincia_id"
                                        value="{{ request()->is('controle/obras/new') ? '' : $dados->cod_provincia_id }}"
                                        required>
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col">
                                    ...
                                    <select class="form-select" id="cod_diocese_id" name="cod_diocese_id"
                                        value="{{ request()->is('controle/obras/new') ? '' : $dados->cod_diocese_id }}"
                                        required>
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col">
                                    ...
                                    <select class="form-select" id="cod_paroquia_id" name="cod_paroquia_id"
                                        value="{{ request()->is('controle/obras/new') ? '' : $dados->cod_paroquia_id }}"
                                        required>
                            ...
                            <div class="row mt-2">
                                <div class="col-6">
                                    ...
                                    <select class="form-select" id="cod_area_id" name="cod_area_id"
                                        value="{{ request()->is('controle/obras/new') ? '' : $dados->cod_area_id }}"
                                        required>
                                ...
                                <div class="col-6">
                                    ...
                                    <select class="form-select" id="cod_setor_id" name="cod_setor_id"
                                        value="{{ request()->is('controle/obras/new') ? '' : $dados->cod_setor_id }}"
                                        required>
                            ...
                            <div class="row mt-2">
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" id="descricao" name="descricao"
                                        value="{{ request()->is('controle/obras/new') ? '' : $dados->descricao }}"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="row mt-2">
                                <div class="col-8">
                                    ...
                                    <input type="text" class="form-control" id="endereco" name="endereco"
                                        value="{{ request()->is('controle/obras/new') ? '' : $dados->endereco }}"
                                        required>
                                </div>
                                ...
                                <div class="col-4">
                                    ...
                                    <input type="cep" class="form-control" id="cep" name="cep"
                                        value="{{ request()->is('controle/obras/new') ? '' : $dados->cep }}">
                                </div>
                            </div>
                            ...
                            <div class="row mt-2">
                                <div class="col-8">
                                    ...
                                    <input type="text" class="form-control" id="site" name="site"
                                        value="{{ request()->is('controle/obras/new') ? '' : $dados->site }}"
                                        required>
                                </div>
                                ...
                                <div class="col-4">
                                    ...
                                    <input type="caixapostal" class="form-control" id="caixapostal" name="caixapostal"
                                        value="{{ request()->is('controle/obras/new') ? '' : $dados->caixapostal }}">
                                </div>
                            </div>
                            ...
                            <div class="row mt-2">
                                <div class="col-8">
                                    ...
                                    <input type="text" class="form-control" id="email1" name="email1"
                                        value="{{ request()->is('controle/obras/new') ? '' : $dados->email1 }}"
                                        required>
                                </div>
                                ...
                                <div class="col-4">
                                    ...
                                    <input type="telefone1" class="form-control" id="telefone1" name="telefone1"
                                        value="{{ request()->is('controle/obras/new') ? '' : $dados->telefone1 }}">
                                </div>
                            </div>
                            ...
                            <div class="row mt-2">
                                <div class="col-8">
                                    ...
                                    <input type="text" class="form-control" id="email2" name="email2"
                                        value="{{ request()->is('controle/obras/new') ? '' : $dados->email2 }}"
                                        required>
                                </div>
                                ...
                                <div class="col-4">
                                    ...
                                    <input type="telefone2" class="form-control" id="telefone2" name="telefone2"
                                        value="{{ request()->is('controle/obras/new') ? '' : $dados->telefone2 }}">
                                </div>
                            </div>
                            ...
                            <div class="row mt-2">
                                <div class="col-8">
                                    ...
                                    <input type="text" class="form-control" id="email3" name="email3"
                                        value="{{ request()->is('controle/obras/new') ? '' : $dados->email3 }}"
                                        required>
                                </div>
                                ...
                                <div class="col-4">
                                    ...
                                    <input type="telefone3" class="form-control" id="telefone3" name="telefone3"
                                        value="{{ request()->is('controle/obras/new') ? '' : $dados->telefone3 }}">
                                </div>
                            </div>
                            ...
                            <div class="row mt-2">
                                <div class="col-6">
                                    ...
                                    <input type="date" class="form-control" id="fundacao" name="fundacao"
                                        value="{{ request()->is('controle/obras/new') ? '' : $dados->fundacao }}">
                                </div>
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="date" class="form-control" id="encerramento" name="encerramento"
                                        value="{{ request()->is('controle/obras/new') ? '' : $dados->encerramento }}">
                                </div>
                            </div>
                            ...
                            <div class="row mt-2">
                                <div class="col">
                                    ...
                                    <textarea class="form-control" id="detalhes" name="detalhes">{{ request()->is('controle/obras/new') ? '' : $dados->detalhes }}</textarea>
                                </div>
                            </div>
