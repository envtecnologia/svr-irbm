            ...
            <div class="row d-flex justify-content-center g-3">
                ...
                <div class="col-6 mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 mb-3">
                            <div class="form-group">
                                <label for="cod_tipoobra_id" class="form-label">Tipo de obra<span
                                        class="required">*</span></label>
                                <select class="form-select" id="cod_tipoobra_id" name="cod_tipoobra_id" required>
                                    <option value="">Selecione o tipo de obra</option>
                                    @forelse($tipos_obras as $r)
                                        <option value="{{ $r->id }}">{{ $r->descricao }}</option>
                                    @empty
                                        <option>Nenhum tipo de obra cadastrado</option>
                                    @endforelse
                                </select>
                            </div>
                        </div>
