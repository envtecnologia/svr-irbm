...
class Cemiterios extends PdfService
{
    /**
    ...
    function cemiteriosPdf($dados)
    {
        ...
        if ($dados->isNotEmpty()) {
            ...
            $this->SetX(22);
            $this->SetFont("Arial", "B", 10);
            $this->Cell(250, 6, iconv("utf-8", "iso-8859-1", "Relatório de Cemitérios ({$dados->count()} registros)"), 1, 0, "L", TRUE);
            $this->Ln();
            $this->Ln(2);
            ...
            $this->SetX(22);
            $this->SetFont("Arial", "B", 8);
            $this->Cell(90, 6, iconv("utf-8", "iso-8859-1", "Cemitério"), 1, 0, "L", TRUE);
            $this->Cell(50, 6, iconv("utf-8", "iso-8859-1", "Cidade"), 1, 0, "L", TRUE);
            $this->Cell(20, 6, iconv("utf-8", "iso-8859-1", "Telefone(1)"), 1, 0, "C", TRUE);
            $this->Cell(20, 6, iconv("utf-8", "iso-8859-1", "Telefone(2)"), 1, 0, "C", TRUE);
            $this->Cell(70, 6, iconv("utf-8", "iso-8859-1", "Contato"), 1, 0, "L", TRUE);
            $this->SetTextColor(0);
            $this->Ln();

            $quantidade = 0;

            foreach ($dados as $cemiterio) {
                $telefone1 = ($cemiterio["telefone1"] != "" ? $cemiterio["telefone1"] : "---");
                $telefone2 = ($cemiterio["telefone2"] != "" ? $cemiterio["telefone2"] : "---");
                $contato = ($cemiterio["contato"] != "" ? $cemiterio["contato"] : "---");
                $cidade = ($cemiterio["cidade"] != "" ? $cemiterio["cidade"]->descricao : "---");
                ...
                $this->Cell(82, 6, iconv("utf-8", "iso-8859-1", $cemiterio["descricao"]), 1, 0, "L", FALSE);
                $this->Cell(50, 6, iconv("utf-8", "iso-8859-1", $cidade), 1, 0, "L", FALSE);
                $this->Cell(20, 6, iconv("utf-8", "iso-8859-1", $telefone1), 1, 0, "C", FALSE);
                $this->Cell(20, 6, iconv("utf-8", "iso-8859-1", $telefone2), 1, 0, "C", FALSE);
                $this->Cell(70, 6, iconv("utf-8", "iso-8859-1", $contato), 1, 0, "L", FALSE);
                $this->SetTextColor(0);
                $this->Ln();
            }
